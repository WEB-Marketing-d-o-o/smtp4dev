										...
										<el-tab-pane label="Mailboxes">
												...
												<div v-for="(mailbox, index) in server.mailboxes" :key="index">
													<el-form-item :prop="'server.mailboxes[' + index + ']'" :rules="{validator: checkMailboxNameUnique}">
														...
														<el-form-item label="SubjectPrefix" :prop="'server.mailboxes[' + index + '].subjectPrefix'" :rules="{required: false}">
															<el-input v-model="mailbox.subjectPrefix" :disabled="server.lockedSettings.mailboxes">
															</el-input>
														</el-form-item>
